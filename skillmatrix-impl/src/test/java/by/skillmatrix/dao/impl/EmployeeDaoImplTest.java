...
public class EmployeeDaoImplTest {
    ...
    static void initData(@Autowired InitTestDataController<EmployeeEntity> employeeTestData) {
        EmployeeDaoImplTest.employeeTestData = employeeTestData;
        EmployeeDaoImplTest.employeeTestData.initTestData(EMPLOYEE_COUNT);
    }
    ...
    void findByIdTest() {
        ...
        EmployeeEntity result = employeeDao.findById(id).get();
