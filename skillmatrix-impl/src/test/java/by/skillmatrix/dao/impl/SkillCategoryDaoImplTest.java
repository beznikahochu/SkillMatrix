...
public class SkillCategoryDaoImplTest {
    ...
    static void initData(
        ...
        SkillCategoryDaoImplTest.schemeTestData = schemeTestData;
        SkillCategoryDaoImplTest.categoryTestData = categoryTestData;
        SkillCategoryDaoImplTest.skillTestData = skillTestData;
    ...
    void findByIdTest() {
        ...
        SkillCategoryEntity result = categoryDao.findById(id).get();
    ...
    void whenFindByIdReturnEmptyTest() {
        Long id = -1l;
        Optional<SkillCategoryEntity> result = categoryDao.findById(id);
    ...
    void findFullSkillCategoryBySchemeIdTest() {
        ...
        List<SkillCategoryEntity> result = categoryDao.findFullSkillCategoryBySchemeId(schemeId);
